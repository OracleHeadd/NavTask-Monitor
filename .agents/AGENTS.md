...
- To compile the C binaries, use: gcc -O2 -mwindows navtask.c navtask.res -o Release/NavTask_Portable_v10.6.exe -liphlpapi -lpdh -lgdi32 -luser32 -lshell32 -ldxgi -luuid -Wall (and also output to NavTask.exe in root).
