...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    int resp = MessageBoxW(NULL, 
        L"Welcome to NavTask Monitor v10.8 Setup for Windows 11 & 10!\n\n"
    ...
    swprintf_s(srcExe, MAX_PATH, L"%s\\..\\Release\\NavTask_Portable_v10.8.exe", currentDir);
